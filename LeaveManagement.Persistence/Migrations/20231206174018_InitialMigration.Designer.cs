...
namespace LeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20231206174018_InitialMigration")]
            ...
            modelBuilder.Entity("LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 12, 6, 18, 40, 18, 710, DateTimeKind.Local).AddTicks(7724),
                            DateModified = new DateTime(2023, 12, 6, 18, 40, 18, 710, DateTimeKind.Local).AddTicks(7777),
                            DefaultDays = 8,
                            Name = "Vacation"
                        });
                });
